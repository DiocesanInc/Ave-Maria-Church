...
/** Lower (non-social) Banner */
// $genericCss->addCssRule(
//     ".lower-banner .the-button",
//     array(
//         "color" => "var(--clr-" . get_field("bottom_banner_background_color", "options") .")",
//         "border-color" => "1px solid var(--clr-" . get_field("bottom_banner_text_color", "options") .")",
//         "background" => "var(--clr-" . get_field("bottom_banner_text_color", "options") .")"
//     )
// );
// $genericCss->addCssRule(
//     ".lower-banner .the-button:hover",
//     array(
//         "background" => "var(--clr-" . get_field("bottom_banner_background_color", "options") .")",
//         "border" => "1px solid var(--clr-" . get_field("bottom_banner_text_color", "options") .")",
...
// $genericCss->addCssRule(
//     ".social-banner .social-link i:hover",
//     array(
//         "border-color" => "var(--clr-" . get_field("bottom_banner_background_color", "options") .")"
//     )
// );
// $genericCss->addCssRule(
//     ".social-banner .social-link i:hover::before",
//     array(
//         "color" => "var(--clr-" . get_field("bottom_banner_background_color", "options") .")"
//     )
// );
