...
if (have_rows("social_buttons")) : ?>
<div class="featured-content-container limit-width" <?php echo TemplateController::isAnimated();?>>
    <?php if (get_field("social_title")) : ?>
    <h2 class="featured-content-title align-center" <?php echo TemplateController::animate("fade-up", 0);?>>
        <?php echo get_field("social_title"); ?>
    </h2>
    <?php endif; ?>

    <div
        class="<?php echo get_field("featured_content_is_slider_social") ? "featured-content-slider " : "featured-content " ?>has-margin same-height">
        <?php while (have_rows("social_buttons")) : the_row(); ?>
        <div class="featured-content-item-wrapper teaser-box" <?php echo TemplateController::animate("zoom-in", 0);?>>
