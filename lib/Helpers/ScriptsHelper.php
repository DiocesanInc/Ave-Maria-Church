...
class ScriptsHelper extends EnqueueHelper
{
    ...
    public static function celineScripts()
    {
        ...
        $filepath = get_template_directory_uri() . "/assets/js/slick-landing.js";
        ...
        $filepath = get_template_directory_uri() . "/assets/js/masonry.js";
        ...
        $filepath = get_template_directory_uri() . "/assets/js/masonry.min.js";
        ...
        $filepath = get_template_directory_uri() . "/assets/js/maps.js";
