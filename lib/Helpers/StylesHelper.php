...
class StylesHelper extends EnqueueHelper
{
    ...
    public static function init()
    {
        add_action(
            ...
            function () {
                ...
                include_once get_template_directory() . "/assets/scss/variables/church_custom_variables.php";
            }
        );
    ...
    public static function get_custom_variables_filename()
    {
        ...
        return "church-avemaria_$blog_id-custom_variables";
    }
    ...
    public static function includeCss()
    {
        ...
        self::_includeStyle();
        self::_includeChildStyle();
        self::_includeSlickStyles();
        self::_includeFontAwesome();
        self::_includeAOS();
        // self::_includeMaterialize();
        if (get_field("custom_scrollbar", "options")) {
            self::_includeCustomScrollbar();
        }
        if (class_exists("CssHelper") && file_exists(WP_PLUGIN_DIR . "/css-helper/church_custom_variables.css")) {
            \CssHelper::enqueueCssFile("church_custom_variables");
        } else {
    ...
    {
        $filepath = get_template_directory_uri() . "/church_custom_variables.css";

        self::_enqueueStyle(
            "church-custom-variables",
            $filepath,
            array(),
            "version",
            "screen"
     ...
     * @return void
     */
    private static function _includeChildStyle()
    {
        $filepath = get_template_directory_uri() . "/style.css";
    ...
    //  * @return void
    //  */
    // private static function _includeMaterialize()
    // {
    //     wp_enqueue_style(
    //         'materialize-css',
